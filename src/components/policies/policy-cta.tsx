...
export default function PolicyCTA() {
    ...
    return (<div className="flex flex-col items-center justify-center gap-8 md:gap-12 w-full">
        <hr className="border border-accent/50 w-full" />

        <div className="flex flex-col items-start bg-info/10 border border-info rounded-xl w-full px-8 md:px-16 py-6 md:py-12 gap-4">
